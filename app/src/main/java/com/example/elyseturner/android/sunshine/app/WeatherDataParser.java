...
public class WeatherDataParser {
    ...
    public static double getMaxTemperatureForDay(String weatherJsonStr, int dayIndex)
        ...
        JSONObject  dayIndexObject = (JSONObject)listArray.get(dayIndex);
        JSONObject tempIndexObject = dayIndexObject.getJSONObject("temp");
        Double maxTemp = tempIndexObject.getDouble ("max");
        return maxTemp;
